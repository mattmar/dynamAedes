...
cd '~/own_data/PoD/topics/aegypti_eu/spatial_data/trento/temperature/'
for year in `seq 2010 2019`; do wget -P gs_ws ftp://ftp.ncdc.noaa.gov/pub/data/gsod/$year/160360-99999-$year.op.gz ;done #Aviano

##R now
#load data
setwd('~/own_data/PoD/topics/aegypti_eu/spatial_data/trento/temperature/gs_ws/')
...
saveRDS(zz,'/home/matteo/own_data/PoD/topics/aedes_genmod/data/t_aviano.RDS')