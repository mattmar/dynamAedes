...
cd ~/own_data/PoD/topics/aegypti_eu/spatial_data/barcelona
for year in `seq 2010 2019`; do wget -P gs_ws ftp://ftp.ncdc.noaa.gov/pub/data/gsod/$year/081800-99999-$year.op.gz ;done #Barcelona
for year in `seq 2010 2019`; do wget -P gs_ws ftp://ftp.ncdc.noaa.gov/pub/data/gsod/$year/081763-99999-$year.op.gz ;done #Sabaddell

setwd('/home/matteo/own_data/PoD/topics/aegypti_eu/spatial_data/barcelona/gs_ws')
...
saveRDS(zz,'/home/matteo/own_data/PoD/topics/aedes_genmod/data/t_barcelona.RDS')