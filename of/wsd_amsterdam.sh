...
##Schipol
##This bit of code must be run in a Unix Shell (Bash)
mkdir -p '~/own_data/PoD/topics/aegypti_eu/spatial_data/amsterdam/temperature/'
cd '~/own_data/PoD/topics/aegypti_eu/spatial_data/amsterdam/temperature/'
for year in `seq 2010 2019`; do wget -P gs_ws ftp://ftp.ncdc.noaa.gov/pub/data/gsod/$year/062400-99999-$year.op.gz ;done

##R now
#load data
setwd('~/own_data/PoD/topics/aegypti_eu/spatial_data/amsterdam/temperature/')
...
amstemp<-zz[zz$yearmoda>"2018-01-01",]$temp