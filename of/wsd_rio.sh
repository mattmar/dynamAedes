...
cd '~/own_data/PoD/topics/aegypti_eu/spatial_data/rio/temperature/'
for year in `seq 2010 2019`; do wget -P gs_ws ftp://ftp.ncdc.noaa.gov/pub/data/gsod/$year/868790-99999-$year.op.gz ;done

##R now
#load data
setwd('~/own_data/PoD/topics/aegypti_eu/spatial_data/rio/temperature/gs_ws/')
...
saveRDS(zz,'/home/matteo/own_data/PoD/topics/aedes_genmod/data/t_rio.RDS')