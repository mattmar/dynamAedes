...
cd ~/own_data/PoD/topics/aegypti_eu/spatial_data/fresno
for year in `seq 2010 2019`; do wget -P gs_ws ftp://ftp.ncdc.noaa.gov/pub/data/gsod/$year/723897-99999-$year.op.gz ;done 

setwd('/home/matteo/own_data/PoD/topics/aegypti_eu/spatial_data/fresno/gs_ws')
...
saveRDS(zz,'/home/matteo/own_data/PoD/topics/aedes_genmod/data/t_fresno.RDS')