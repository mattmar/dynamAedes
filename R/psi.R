...
#' @param input_sim (matrix) dynamAedes compressed output matrix (compressed=TRUE). 
...
#' @return psi returns the proportion of model iterations that resulted in a viable mosquito population (defined as: iterations with at least one individual alive in any life stage) at a given date.
