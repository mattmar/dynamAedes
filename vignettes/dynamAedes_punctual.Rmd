---
title: "Describing the main features of *dynamAedes*: the punctual scale model."
...
output: 
  ...
  toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Describing the main features of *dynamAedes*: the punctual scale model.}
