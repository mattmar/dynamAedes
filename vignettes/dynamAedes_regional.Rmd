---
title: "Describing the main features of *dynamAedes*: the regional scale model."
...
output: 
  ...
  toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Describing the main features of *dynamAedes*: the regional scale model.}
